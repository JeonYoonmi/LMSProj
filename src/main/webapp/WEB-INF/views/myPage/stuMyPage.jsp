...
$('#changePwInsertBtn').on('click',function(){
	$('#prePw').attr('value','java');
	$('#newPw').attr('value','Asdf#1234');
	$('#newPwCon').attr('value','Asdf#1234');
})
...
<Button type="button" id="changePwInsertBtn" 
style="position:absolute;top:350px;right : 730px;"
class="btn btn-secondary">자동입력</Button>
