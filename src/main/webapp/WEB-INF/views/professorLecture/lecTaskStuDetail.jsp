					...
					<div class="alert alert-warning" role="alert" style="font-size: 0.9em;">	
						...
						<table class="table" style="border-bottom: 1px solid #eef2f7;">
											...
											<div class="card mb-1 shadow-none border">
												<div class="p-2">
													<div class="row align-items-center">
														<div class="col-auto">
															<div class="avatar-sm">
																<span class="avatar-title bg-secondary rounded">${ fn:substring(taskSubmit.tsubFnm, fn:indexOf(taskSubmit.tsubFnm, '.') + 1, fn:length(taskSubmit.tsubFnm))}</span>
															</div>
														</div>
														<div class="col pl-0">
															<a href="javascript:void(0);" class="text-muted font-weight-bold">${ fn:substring(taskSubmit.tsubFnm, fn:indexOf(taskSubmit.tsubFnm, '_') + 1, fn:length(taskSubmit.tsubFnm)) }</a>
														</div>
														<div class="col-auto">
															<!-- Button -->
															<a href="javascript:void(0);" onclick="fn_download('${taskSubmit.tsubFnm}')" class="btn btn-link btn-lg text-muted"> <i class="dripicons-download"></i>
															</a>
														</div>
													</div>
												</div>
							...
							<tr>
								...
								<td>
									<input type="number" name="tsubScore" id="taskScore" min="0" max="${data.taskScore }" step="5" value="${taskSubmit.tsubScore }" class="form-control"/>&nbsp;/&nbsp;${data.taskScore }
								</td>
							</tr>
						</table>
