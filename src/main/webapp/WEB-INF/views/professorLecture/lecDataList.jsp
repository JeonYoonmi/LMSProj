		...
		<div class="card" style="min-height: 700px;">
			<div class="card-body">
				...
				<c:if test="${ memSession.professorVO.proCd != null }">
					<a href="/professorLecture/lecDataInsert?lecCd=${data.lecCd }" class="btn btn-primary btn-sm" style="float:right;margin-bottom: 30px;">등록</a>
				</c:if>
				...
				<c:if test="${empty list}">
					<tr style="border-bottom: 1px solid #eef2f7">
						<td colspan="5" style="text-align: center;color: #888;">등록된 자료가 존재하지 않습니다.</td>
					</tr>				
				</c:if>
