...
<div id="calRound">
<div>
<i class="mdi mdi-home" style="font-size: 1.3em"></i> <i class="dripicons-chevron-right"></i> 마이 페이지 <i class="dripicons-chevron-right"></i> <span style="font-weight: bold;">개인 일정 관리</span> 
</div>
<br><br>
                            ...
                            <div class="modal-body p-3">
                                <form class="p-1">
                                    ...
                                    <div class="form-group write-mdg-box mb-3">
                                        <label>내용</label>
                                        <textarea id="schCon" rows="4" cols="53" style="width: 100%; border: 1px solid lightgray;"></textarea>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-3">
                                <form class="p-1">
                                	...
                                	<div>
                                	<label>시간</label><br>
                					<input type="datetime-local" class="inputDate" id="modalStUp" style="border : 1px solid lightgray;">
                					<input type="datetime-local" class="inputDate"  id="modalEnUp" style="border : 1px solid lightgray;">
                                	</div>
