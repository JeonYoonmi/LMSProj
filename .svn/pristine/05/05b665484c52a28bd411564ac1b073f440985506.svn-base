		...
		<nav class="navbar navbar-dark navbar-expand-lg navbarmenu">
			...
			<div class="collapse navbar-collapse" id="topnav-menu-content">
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle arrow-none" href="/approval/managerApprovalListGet"
						id="topnav-apps">
						결재
					</a></li>
					<li class="nav-item dropdown"><a
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle arrow-none" onclick="fn_mail()" style="cursor: pointer;" 
						id="topnav-apps">
						교내메일
					</a></li>
				</ul>
