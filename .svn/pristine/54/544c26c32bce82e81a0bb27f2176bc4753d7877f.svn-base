...
public interface TotalGradeMapper {
	...
	//포틀릿용 학점 조회 - 신청 학점 불러오기
	public int ptlGetTotal(Map<String, Object> map);
	
	//포틀릿용 학점 조회 - 취득 학점 불러오기
	public int ptlGetTotalNotF(Map<String, Object> map);
	
	//성적 도넛 차트로 보여주기
	public Map<String, Object> doughnut(int memCd);
