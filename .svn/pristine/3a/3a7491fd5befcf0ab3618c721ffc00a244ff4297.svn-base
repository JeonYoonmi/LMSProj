...
<div id="graduateGetRound">
	<div>
		<i class="mdi mdi-home" style="font-size: 1.3em"></i> <i class="dripicons-chevron-right"></i> 학적관리 <i class="dripicons-chevron-right"></i> <span style="font-weight: bold;">졸업신청</span>
	</div>
<div>
<br>
<table id = "stuInfoTable">
	...
	<button type="button" class="btn btn-primary btnRight" id="applyBut" style="margin-right: 10px;">졸업신청</button>
