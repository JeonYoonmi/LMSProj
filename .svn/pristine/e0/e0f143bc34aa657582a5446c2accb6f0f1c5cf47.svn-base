...
<!-- 	    <h5 class="card-title">Dark card title</h5> -->
	    <p class="card-text" style="text-align:center;">
	    	<img src="/resources/images/error400.jpg" alt="page-misc-error-light" style="width:60%;" class="img-fluid" data-app-dark-img="/resources/images/error400.jpg" data-app-light-img="/resources/images/error400.jpg">
	    </p>
	  </div>
	</div>
	<!-- ----------------- 400 오류 메시지 끝 ------------------------------ -->
