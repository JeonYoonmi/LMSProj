			...
			<div class="collapse navbar-collapse" id="topnav-menu-content">
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						<a href="/main/ui" class="nav-link dropdown-toggle arrow-none"
						id="topnav-apps">
						통합 정보 시스템
						</a>
					</li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle arrow-none" href="/studentLecture/stuList"
						id="topnav-apps">
						사이버 캠퍼스
					</a></li>
					<li class="nav-item dropdown"><a
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle arrow-none" href="/main/register"
						id="topnav-apps">
						수강신청
					</a></li>
				</ul>
