...
<div class="mainTotalWrapper">
		...
		<div class="quickMenu">
			...
			<div class="quicksubmenu">
				...
				<div class="menu">
					...
					<p class="quickMenuName"><a href="https://kaist.certpia.com/" style="color: #333;">증명서 발급<br>certpia</a></p>
				</div>
				<!-- 메뉴 -->
				<div class="menu">
			...
			<div style="width: 100%;">
				<div class="lock">
					...
					<div class="cLock goalDivDiv">
						<p class="ntcTtl"><i class='mdi mdi-transition-masked'></i>IJU With U</p>
						<div class="goalDiv">
  ...
  <script type="text/javascript" defer="defer">
	...
	var RC003 = "";
		...
		RC003 += "<c:if test = '${not empty stuCounsel}'>";
		RC003 += "<table class='ptable'>";
        RC003 += "<thead>";
        ...
        RC003 += "<td>[${stuCounsel.cnslCate}]${stuCounsel.cnslTtl}</td>";
        RC003 += "<td>${stuCounsel.cnslYn}</td></tr>";
        RC003 += "</c:forEach>";
        RC003 += "</tbody>";
        RC003 += "</table>";
        RC003 += "</c:if>";
        RC003 += "<c:if test = '${not empty proCounsel}'>";
		RC003 += "<table id='ptable'>";
        RC003 += "<thead>";
        ...
        RC003 += "<td>[${proCounsel.cnslCate}]${proCounsel.cnslTtl}</td>";
        RC003 += "<td>${proCounsel.memNm}(${proCounsel.stuCd})</td></tr>";
        RC003 += "</c:forEach>";
        RC003 += "</tbody>";
        RC003 += "</table>";
        RC003 += "</div>";
	...
	var RC004 = "";
		...
		RC004 += '<table id="portletRegHistoryTable" class="ptable" style="width:100%;">';
	...
	var RC006 = "";
		...
		RC006 += "<c:if test='${not empty currentLecture}'><c:forEach var='curLec' items='${currentLecture}'>";
		RC006 += "<div class='toast-body'><span>${curLec.lecaNm}</span><span>${curLec.lecaCon}</span>";
		RC006 += "<div class='mt-2 pt-2 border-top'>여기서부터 해야해용 학기<a href='/professorLecture/lecApply?lecCd=${curLec.lecCd }' class='btn btn-secondary btn-sm' data-bs-dismiss='toast'>강의실로 이동</a></div></div>";
		RC006 += "</c:forEach></c:if>";
	...
	var RC008 = ""
		...
		RC008 += '<tr><td rowspan="5" id="totalInfo"><img id="weatherImg" /><span id="weatherTemp"></span></td>';
	...
	var RC011 = ""
		...
		RC011 += "<hr style='margin: 0px; border: 0; background: lightgray; height:1px;'>";
		RC011 += "<div class='noticeDiv'><p class='noticeP' style='margin-left: -15px;'>[교육부] 스포츠 관람, 공연 등 대학 행사 시 실외마스크 착용의무 준수 안내</p><p style='display:inline-block; float: right;'><span style='color : gray;'>22.05.31</span></p></div>"
		RC011 += "<hr style='margin: 0px; border: 0; background: lightgray; height:1px;'>";
	...
	var RC012 = "";
        ...
        RC012 += '<div style="float:left; width:40%;"><select id="portletTgrade" onchange="javascript:getTimeTable(this);" style="border:1px solid lightgray; height:27px; float:left;">';
